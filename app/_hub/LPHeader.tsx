      ...
      >
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16 h-16 flex items-center justify-between gap-8">
          <Link href="/" aria-label="Midlej Capital, voltar ao hub" className="inline-flex items-center gap-3 shrink-0">
            <Image src="/icon_midlej.png" alt="" width={32} height={32} className="h-8 w-8 object-contain" aria-hidden />
            <span style={{ color: "#2E4659", fontFamily: "var(--font-brand), ui-sans-serif, system-ui, sans-serif", fontSize: "1.125rem", fontWeight: 700, letterSpacing: "0.01em" }}>
              Midlej Capital
            </span>
          </Link>
